...
def load_data():
    ...
    for name, col in TP_COLS.items():
        df[f"_tp_{name}"] = to_num(df[col])
    for name, col in TPK_COLS.items():
        df[f"_tpk_{name}"] = to_num(df[col])
...
with tabs[0]:
    ...
    with col_l:
        ...
        st.plotly_chart(fig, use_container_width=True, key="chart_1", config={"displayModeBar": False})
    ...
    with col_r:
        ...
        fig_layout(fig2, 200)
        st.plotly_chart(fig2, use_container_width=True, key="chart_2", config={"displayModeBar": False})
    ...
    st.plotly_chart(fig_map, use_container_width=True, key="chart_3", config={"displayModeBar": False})
    ...
    with v1:
        ...
        st.plotly_chart(fig_c, use_container_width=True, key="chart_4", config={"displayModeBar": False})
    ...
    with v2:
        ...
        st.plotly_chart(fig_br, use_container_width=True, key="chart_5", config={"displayModeBar": False})
...
with tabs[1]:
    ...
    st.plotly_chart(fig_tp, use_container_width=True, key="chart_6", config={"displayModeBar": False})
    ...
    with r1:
        ...
        st.plotly_chart(fig_r, use_container_width=True, key="chart_7", config={"displayModeBar": False})
    ...
    with r2:
        ...
        st.plotly_chart(fig_ht, use_container_width=True, key="chart_8", config={"displayModeBar": False})
    ...
    if ivp_rows:
        ...
        st.plotly_chart(fig_ivp, use_container_width=True, key="chart_9", config={"displayModeBar": False})
...
with tabs[2]:
    ...
    with w1:
        ...
        st.plotly_chart(fig_tw, use_container_width=True, key="chart_10", config={"displayModeBar": False})
    with w2:
        ...
        st.plotly_chart(fig_cw, use_container_width=True, key="chart_11", config={"displayModeBar": False})
    ...
    with w3:
        ...
        st.plotly_chart(fig_pt, use_container_width=True, key="chart_12", config={"displayModeBar": False})
    with w4:
        ...
        st.plotly_chart(fig_pc, use_container_width=True, key="chart_13", config={"displayModeBar": False})
    ...
    st.plotly_chart(fig_wa, use_container_width=True, key="chart_14", config={"displayModeBar": False})
...
with tabs[3]:
    ...
    with b1:
        ...
        st.plotly_chart(fig_bc, use_container_width=True, key="chart_15", config={"displayModeBar": False})
    with b2:
        ...
        st.plotly_chart(fig_sv, use_container_width=True, key="chart_16", config={"displayModeBar": False})
    with b3:
        ...
        st.plotly_chart(fig_tx, use_container_width=True, key="chart_17", config={"displayModeBar": False})
    ...
    st.plotly_chart(fig_gap, use_container_width=True, key="chart_18", config={"displayModeBar": False})
...
with tabs[4]:
    ...
    with e1:
        ...
        st.plotly_chart(fig_pe, use_container_width=True, key="chart_19", config={"displayModeBar": False})
    with e2:
        ...
        st.plotly_chart(fig_ne, use_container_width=True, key="chart_20", config={"displayModeBar": False})
    ...
    st.plotly_chart(fig_eh, use_container_width=True, key="chart_21", config={"displayModeBar": False})
    ...
    with dg1:
        ...
        st.plotly_chart(fig_dh, use_container_width=True, key="chart_22", config={"displayModeBar": False})
    with dg2:
        ...
        st.plotly_chart(fig_dr, use_container_width=True, key="chart_23", config={"displayModeBar": False})
...
with tabs[5]:
    ...
    with s1:
        ...
        st.plotly_chart(fig_g, use_container_width=True, key="chart_24", config={"displayModeBar": False})
    with s2:
        ...
        fig_m.update_layout(paper_bgcolor="#0d1117", plot_bgcolor="#161b22", font=dict(color="#8b949e", size=12),
                             ...
                             legend=dict(font=dict(color="#c9d1d9", size=12), bgcolor="#0d1117"))
        st.plotly_chart(fig_m, use_container_width=True, key="chart_25", config={"displayModeBar": False})
    ...
    with s3:
        ...
        st.plotly_chart(fig_a, use_container_width=True, key="chart_26", config={"displayModeBar": False})
    with s4:
        ...
        st.plotly_chart(fig_t, use_container_width=True, key="chart_27", config={"displayModeBar": False})
    ...
    with se1:
        ...
        st.plotly_chart(fig_edu, use_container_width=True, key="chart_28", config={"displayModeBar": False})
    with se2:
        ...
        st.plotly_chart(fig_j, use_container_width=True, key="chart_29", config={"displayModeBar": False})
    ...
    with se3:
        ...
        st.plotly_chart(fig_i, use_container_width=True, key="chart_30", config={"displayModeBar": False})
    with se4:
        ...
        st.plotly_chart(fig_ex, use_container_width=True, key="chart_31", config={"displayModeBar": False})
    ...
    with ns1:
        ...
        st.plotly_chart(fig_na, use_container_width=True, key="chart_32", config={"displayModeBar": False})
    with ns2:
        ...
        st.plotly_chart(fig_nj, use_container_width=True, key="chart_33", config={"displayModeBar": False})
    with ns3:
        ...
        st.plotly_chart(fig_nt, use_container_width=True, key="chart_34", config={"displayModeBar": False})
